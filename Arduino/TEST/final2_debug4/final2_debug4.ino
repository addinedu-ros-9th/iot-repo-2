...
void handleSerialCommand(String cmd) {
    ...
    else if (cmd == "CFD") { error_fall = false; sendTCPData("SE", 4); }
    else if (cmd == "CHT") { error_highT = false; sendTCPData("SE", 4); }
    else if (cmd == "CLT") { error_lowT = false; sendTCPData("SE", 4); }
    else if (cmd == "CHH") { error_highHR = false; sendTCPData("SE", 4); }
    else if (cmd == "CLH") { error_lowHR = false; sendTCPData("SE", 4); }
    else if (cmd == "CLS") { error_lowSPO2 = false; sendTCPData("SE", 4); }
...
void loop() {
    ...
    if (tempC > 39.0) error_highT = true;
    if (tempC < 35.0) error_lowT = true;
