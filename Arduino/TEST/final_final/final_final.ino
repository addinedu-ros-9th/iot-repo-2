        ...
        if (idx != -1 && idx + 1 < raw.length()) {
            ...
            if (msg.startsWith("GN")) {
                ...
                if (status == '0') {
                    ...
                    if (error == "404") Serial.println("사용자 없음");
                    else if (error == "500") Serial.println("서버 오류");
                    else Serial.println("알 수 없는 오류");
                } else {
                ...
                if (code == "DB") Serial.println("[ERROR] DB: DB 오류");
                else if (code == "FT") Serial.println("[ERROR] FT: 데이터 형식 오류");
                else if (code == "AU") Serial.println("[ERROR] AU: 사용자 인증 오류");
                else if (code == "CM") Serial.println("[ERROR] CM: 명령어 오류");
                else if (code == "SV") Serial.println("[ERROR] SV: 서버 내부 오류");
                else Serial.println("[ERROR] 알 수 없는 오류 코드");
            }
            else {
